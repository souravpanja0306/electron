...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .route-bar strong { font-size: 11.5px; }
        ...
        /* ── NOTE ── */
        .note-row { border-top: 1px solid #000; }
        .note-row td { border: 1px solid #000; padding: 8px 12px; font-size: 10.5px; }
        ...
        .sig-table td { padding: 0 8px; text-align: center; vertical-align: bottom; width: 33%; }
...
<div class="page">
    ...
    <div class="header">
        ...
        <div class="header-right">
            ${company.logo ? `<img src="${company.logo}" alt="Logo" style="max-height:70px; max-width:160px; object-fit:contain;" />` : `<div style="width:160px; height:70px; border:1px dashed #aaa; display:flex; align-items:center; justify-content:center; font-size:9px; color:#aaa; text-align:center;">LOGO<br/>160×70</div>`}
        </div>
    </div>
    ...
    <div class="footer">
        ...
        <div class="footer-note">The consignment note is subject to terms &amp; conditions printed overleaf.</div>
    </div>
